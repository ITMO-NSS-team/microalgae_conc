...
def form_autosegmented_concentrations():
    ...
    auto_segmented_df.columns = ['im1', 'im2', 'im3', 'im4', 'im5', 'im6', 'im7', 'im8', 'im9', 'im10']
    auto_segmented_df['Sample'] = names
    auto_segmented_df = auto_segmented_df[['Sample', 'im1', 'im2', 'im3', 'im4', 'im5', 'im6', 'im7', 'im8', 'im9', 'im10']]
...
# Create boxplots
box1 = plt.boxplot(expert_data_sorted,
                  positions=positions - 0.2,  # Offset left
                  widths=0.4,
                  patch_artist=True,
                  boxprops=dict(facecolor='lightblue'),
...
box2 = plt.boxplot(auto_data_sorted,
                  positions=positions + 0.2,  # Offset right
                  widths=0.4,
                  patch_artist=True,
                  boxprops=dict(facecolor='lightgreen'),
